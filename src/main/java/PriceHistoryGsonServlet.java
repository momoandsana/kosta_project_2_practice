import com.google.gson.Gson; // Gson 클래스 임포트
...
public class PriceHistoryGsonServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { // GET 요청 처리
        ...
        try {
            ...
            String json = gson.toJson(priceHistory); // 가격 히스토리를 JSON 문자열로 변환
